...
type BacktestMetrics struct {
	...
	FundingCost   float64                `protobuf:"fixed64,7,opt,name=funding_cost,json=fundingCost,proto3" json:"funding_cost,omitempty"`    // 资金费净支出（正=付出，负=收入；仅永续，M6.5）
	Liquidated    bool                   `protobuf:"varint,8,opt,name=liquidated,proto3" json:"liquidated,omitempty"`                          // 回测期间是否触发强平（仅永续，M6.5）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BacktestMetrics) GetFundingCost() float64 {
	if x != nil {
		return x.FundingCost
	}
	return 0
}

func (x *BacktestMetrics) GetLiquidated() bool {
	if x != nil {
		return x.Liquidated
	}
	return false
...
const file_quant_proto_rawDesc = "" +
	...
	"\ffunding_cost\x18\a \x01(\x01R\vfundingCost\x12\x1e\n" +
	"\n" +
	"liquidated\x18\b \x01(\bR\n" +
	"liquidated\"7\n" +
